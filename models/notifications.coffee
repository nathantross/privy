        ...
        unless participant.userId == user._id
          ...
          if !pUser.status?.online || pUser.status?.idle
            ...
            Email.send
              ...
              text: "You have a new message at https://privy.cc/threads/" + emailAttr.threadId
              html: "<center><img src='" + emailAttr.senderAvatar + "' /><br><br>You have a new message:<br><br><h1>" + emailAttr.lastMessage + "</h1><br><a href='https://privy.cc/threads/" + emailAttr.threadId + "' >Click here to respond</a></center>"
